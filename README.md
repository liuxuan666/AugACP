...
# Usage
* First, please extract the file "Data/3D_structure.zip" from the original directory. It should be noted that **“Data/unknown_label.csv”** contains the complete set of candidate negative samples collected from the Human PeptideAtlas database. During data preparation, our code randomly samples negative samples at a **5:1 negative-to-positive ratio** from this candidate pool.
